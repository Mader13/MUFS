...
@Component({
  selector: 'app-create-study-page',
  templateUrl: './create-study-page.component.html',
  styleUrls: ['./create-study-page.component.scss'],
})
export class CreateStudyPageComponent implements OnInit {
  user!: User;
  Project!: Project;
